// Command HomepageScreenshot-mcp is an MCP server exposing the HomepageScreenshot
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HomepageScreenshot_list  — list records of an entity
//	HomepageScreenshot_load  — load a single record of an entity
//
