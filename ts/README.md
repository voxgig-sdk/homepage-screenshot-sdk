# HomepageScreenshot TypeScript SDK



The TypeScript SDK for the HomepageScreenshot API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.GetScreenshotByDomain()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `HomepageScreenshotSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `HomepageScreenshotSDK.test(testopts?, sdkopts?)` | `HomepageScreenshotSDK` | Create a test-mode client. |
...
homepage-screenshot/
├── src/
│   ├── HomepageScreenshotSDK.ts        # Main SDK class
