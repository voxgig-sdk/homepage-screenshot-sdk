...
(0, node_test_1.describe)('GetScreenshotByDomainAndDateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HomepageScreenshotSDK({
    ...
    (0, node_test_1.test)('direct-load-get_screenshot_by_domain_and_date', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_screenshot_by_domain_and_date', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HOMEPAGE_SCREENSHOT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HomepageScreenshotSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HOMEPAGE_SCREENSHOT_TEST_GET_SCREENSHOT_BY_DOMAIN_AND_DATE_ENTID'];
    ...
    const client = new __1.HomepageScreenshotSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetScreenshotByDomainAndDateDirect.test.js.map