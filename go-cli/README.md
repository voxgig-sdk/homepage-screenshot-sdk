...
AQL-driven command-line client **and** interactive REPL for the HomepageScreenshot
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `get_screenshot_by_domain`).
