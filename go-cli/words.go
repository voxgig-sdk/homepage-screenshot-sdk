...
func registerSDKWords(r *eng.Registry, client *sdk.HomepageScreenshotSDK) {
...
func runOp(client *sdk.HomepageScreenshotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
