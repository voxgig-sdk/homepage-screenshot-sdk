...
// instead of `sdk.NewHomepageScreenshotSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HomepageScreenshotSDK  { return NewHomepageScreenshotSDK(nil) }
func Test() *HomepageScreenshotSDK { return TestSDK(nil, nil) }
