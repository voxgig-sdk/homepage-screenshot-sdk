...
type HomepageScreenshotSDK struct {
	Mode     string
...
func (sdk *HomepageScreenshotSDK) OptionsMap() map[string]any {
...
func (sdk *HomepageScreenshotSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HomepageScreenshotSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HomepageScreenshotSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HomepageScreenshotSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HomepageScreenshotSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HomepageScreenshotSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HomepageScreenshotSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HomepageScreenshotSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HomepageScreenshotSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HomepageScreenshotSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HomepageScreenshotSDK {
	...
	sdk := NewHomepageScreenshotSDK(sdkopts)
	sdk.Mode = "test"
