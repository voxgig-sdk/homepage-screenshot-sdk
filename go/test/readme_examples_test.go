...
const testSeed = `map[string]any{"entity": map[string]any{"get_screenshot_by_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_screenshot_by_domain_and_date": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
