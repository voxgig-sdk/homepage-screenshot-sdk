# HomepageScreenshot Python SDK Reference

Complete API reference for the HomepageScreenshot Python SDK.
...
#### `HomepageScreenshotSDK.test(testopts=None, sdkopts=None)`
...
#### `GetScreenshotByDomain(data=None)`

Create a new `GetScreenshotByDomainEntity` instance. Pass `None` for no initial data.

#### `GetScreenshotByDomainAndDate(data=None)`

Create a new `GetScreenshotByDomainAndDateEntity` instance. Pass `None` for no initial data.
...
Create a new `GetScreenshotByDomainEntity` instance with the same options.
...
Create a new `GetScreenshotByDomainAndDateEntity` instance with the same options.
