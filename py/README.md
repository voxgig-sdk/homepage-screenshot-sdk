# HomepageScreenshot Python SDK



The Python SDK for the HomepageScreenshot API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetScreenshotByDomain()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/homepage-screenshot-sdk/releases)) or
...
```
py/
├── homepagescreenshot_sdk.py         -- Main SDK module
