...
class GetScreenshotByDomainEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetScreenshotByDomainEntity(self._client, opts)
    ...
    def data_get(self) -> GetScreenshotByDomain:
    ...
    def match_get(self) -> GetScreenshotByDomain:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetScreenshotByDomain:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetScreenshotByDomain().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
