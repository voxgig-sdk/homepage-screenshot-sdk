...
from homepagescreenshot_sdk.homepagescreenshot_types import (
...
class GetScreenshotByDomainAndDateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetScreenshotByDomainAndDateEntity(self._client, opts)
    ...
    def data_get(self) -> GetScreenshotByDomainAndDate:
    ...
    def match_get(self) -> GetScreenshotByDomainAndDate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetScreenshotByDomainAndDate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetScreenshotByDomainAndDate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
