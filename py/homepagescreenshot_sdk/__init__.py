...
from homepagescreenshot_sdk.utility import register

# Load features
from homepagescreenshot_sdk.feature.base_feature import HomepageScreenshotBaseFeature
from homepagescreenshot_sdk.features import _has_feature, _make_feature
...
class HomepageScreenshotSDK:
    ...
    def get_utility(self):
        return HomepageScreenshotUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HomepageScreenshotSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetScreenshotByDomain(self, data=None) -> "GetScreenshotByDomainEntity":
        ...
        from homepagescreenshot_sdk.entity.get_screenshot_by_domain_entity import GetScreenshotByDomainEntity
    ...
    def GetScreenshotByDomainAndDate(self, data=None) -> "GetScreenshotByDomainAndDateEntity":
        ...
        from homepagescreenshot_sdk.entity.get_screenshot_by_domain_and_date_entity import GetScreenshotByDomainAndDateEntity
