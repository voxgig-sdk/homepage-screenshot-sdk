# HomepageScreenshot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HomepageScreenshotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HomepageScreenshotSDK(...) and HomepageScreenshotSDK.test(...) become
#      HomepageScreenshotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "homepagescreenshot_sdk"
_SDK_CLASS = "HomepageScreenshotSDK"
...
_ENTITIES = {
    "GetScreenshotByDomain": "get_screenshot_by_domain",
    "GetScreenshotByDomainAndDate": "get_screenshot_by_domain_and_date",
}
