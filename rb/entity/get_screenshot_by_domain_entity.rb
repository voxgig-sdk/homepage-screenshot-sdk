...
class GetScreenshotByDomainEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "get_screenshot_by_domain"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    GetScreenshotByDomainEntity.new(@_client, opts)
  end
  ...
  # @return [GetScreenshotByDomain, Hash] the current GetScreenshotByDomain data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetScreenshotByDomain fields)
  def match_get
