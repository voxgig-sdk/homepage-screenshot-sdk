# HomepageScreenshot Ruby SDK Reference

Complete API reference for the HomepageScreenshot Ruby SDK.
...
#### `HomepageScreenshotSDK.test(testopts = nil, sdkopts = nil)`
