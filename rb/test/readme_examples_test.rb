...
#      offline in seeded test mode (HomepageScreenshotSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HomepageScreenshot_sdk.rb")
  SDK_CLASS = "HomepageScreenshotSDK"
  ...
  SDK_BASE = "HomepageScreenshot_sdk"
