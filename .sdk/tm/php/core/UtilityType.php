...
// HomepageScreenshot SDK utility type

class HomepageScreenshotUtility
{
    ...
    public static function copy(HomepageScreenshotUtility $src): HomepageScreenshotUtility
    {
        $u = new HomepageScreenshotUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
