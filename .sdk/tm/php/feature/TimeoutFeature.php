...
// HomepageScreenshot SDK timeout feature
...
class HomepageScreenshotTimeoutFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _with_timeout(HomepageScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HomepageScreenshotContext $_ctx, float $ms): void
    {
        $client = $this->client;
