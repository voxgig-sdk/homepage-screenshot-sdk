...
// HomepageScreenshot SDK paging feature
...
class HomepageScreenshotPagingFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _is_list(HomepageScreenshotContext $ctx): bool
    {
