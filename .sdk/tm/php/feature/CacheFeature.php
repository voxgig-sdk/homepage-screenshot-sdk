...
// HomepageScreenshot SDK cache feature
...
class HomepageScreenshotCacheFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _through(HomepageScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
