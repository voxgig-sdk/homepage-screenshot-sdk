...
// HomepageScreenshot SDK metrics feature
...
class HomepageScreenshotMetricsFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _record(HomepageScreenshotContext $ctx, bool $ok): void
    {
