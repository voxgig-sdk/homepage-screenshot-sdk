...
// HomepageScreenshot SDK audit feature
...
class HomepageScreenshotAuditFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _emit(HomepageScreenshotContext $ctx, string $outcome): void
    {
