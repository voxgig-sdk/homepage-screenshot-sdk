...
// HomepageScreenshot SDK ratelimit feature
...
class HomepageScreenshotRatelimitFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _acquire(HomepageScreenshotContext $ctx): void
    {
    ...
    private function _track(HomepageScreenshotContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
