...
// HomepageScreenshot SDK idempotency feature
...
class HomepageScreenshotIdempotencyFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _mutating(HomepageScreenshotContext $ctx): bool
    {
