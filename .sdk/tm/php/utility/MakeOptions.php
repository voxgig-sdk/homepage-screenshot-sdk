...
// HomepageScreenshot SDK utility: make_options

class HomepageScreenshotMakeOptions
{
    ...
    public static function call(HomepageScreenshotContext $ctx): array
    {
        ...
        //
        // `HomepageScreenshotSchema::optspec()` is built from the model:
        ...
        $optspec = HomepageScreenshotSchema::optspec();
