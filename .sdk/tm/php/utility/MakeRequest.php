...
// HomepageScreenshot SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HomepageScreenshotMakeRequest
{
    public static function call(HomepageScreenshotContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HomepageScreenshotResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HomepageScreenshotResponse($fetched);
        } else {
