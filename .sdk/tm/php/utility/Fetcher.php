...
// HomepageScreenshot SDK utility: fetcher

class HomepageScreenshotFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HomepageScreenshotSDK/1.0)';
    ...
    public static function call(HomepageScreenshotContext $ctx, string $fullurl, array $fetchdef): array
    {
