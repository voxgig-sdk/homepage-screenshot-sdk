...
class HomepageScreenshotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HomepageScreenshotTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HomepageScreenshotTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HomepageScreenshotTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
