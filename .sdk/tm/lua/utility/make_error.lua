...
local function make_error_util(ctx, err)
  ...
  local msg = "HomepageScreenshotSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HomepageScreenshotError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HomepageScreenshotError then
