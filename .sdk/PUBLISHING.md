...
|---|---|---|
| `ts/` | @voxgig-sdk/homepage-screenshot-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/homepage-screenshot-sdk \
      --repository voxgig-sdk/homepage-screenshot-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/homepage-screenshot-sdk` shows it, and
`npm trust revoke @voxgig-sdk/homepage-screenshot-sdk --id=<id>` removes it.
