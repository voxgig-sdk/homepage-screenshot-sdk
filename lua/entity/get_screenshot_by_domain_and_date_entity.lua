...
local GetScreenshotByDomainAndDateEntity = {}
GetScreenshotByDomainAndDateEntity.__index = GetScreenshotByDomainAndDateEntity


function GetScreenshotByDomainAndDateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetScreenshotByDomainAndDateEntity)
  self._name = "get_screenshot_by_domain_and_date"
  self._client = client
...
function GetScreenshotByDomainAndDateEntity:get_name()
  return self._name
end


function GetScreenshotByDomainAndDateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetScreenshotByDomainAndDateEntity.new(self._client, opts)
end
...
function GetScreenshotByDomainAndDateEntity:mark_deleted()
  self._deleted = true
end


function GetScreenshotByDomainAndDateEntity:deleted()
  return true == self._deleted
end


function GetScreenshotByDomainAndDateEntity:data_set(args)
  if args ~= nil then
...
function GetScreenshotByDomainAndDateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetScreenshotByDomainAndDateEntity:match_set(args)
  if args ~= nil then
...
function GetScreenshotByDomainAndDateEntity:match_get()
...
function GetScreenshotByDomainAndDateEntity:stream(action, args, callopts)
...
function GetScreenshotByDomainAndDateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetScreenshotByDomainAndDateEntity
