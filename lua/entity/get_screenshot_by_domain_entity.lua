...
local GetScreenshotByDomainEntity = {}
GetScreenshotByDomainEntity.__index = GetScreenshotByDomainEntity


function GetScreenshotByDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetScreenshotByDomainEntity)
  self._name = "get_screenshot_by_domain"
  self._client = client
...
function GetScreenshotByDomainEntity:get_name()
  return self._name
end


function GetScreenshotByDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetScreenshotByDomainEntity.new(self._client, opts)
end
...
function GetScreenshotByDomainEntity:mark_deleted()
  self._deleted = true
end


function GetScreenshotByDomainEntity:deleted()
  return true == self._deleted
end


function GetScreenshotByDomainEntity:data_set(args)
  if args ~= nil then
...
function GetScreenshotByDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetScreenshotByDomainEntity:match_set(args)
  if args ~= nil then
...
function GetScreenshotByDomainEntity:match_get()
...
function GetScreenshotByDomainEntity:stream(action, args, callopts)
...
---@param reqmatch GetScreenshotByDomainLoadMatch
---@param ctrl? table
---@return GetScreenshotByDomain
---@return string? err
function GetScreenshotByDomainEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetScreenshotByDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetScreenshotByDomainEntity
