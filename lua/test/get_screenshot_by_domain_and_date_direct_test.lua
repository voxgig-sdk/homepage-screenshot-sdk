...
describe("GetScreenshotByDomainAndDateDirect", function()
  it("should direct-load-get_screenshot_by_domain_and_date", function()
    local setup = get_screenshot_by_domain_and_date_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_screenshot_by_domain_and_date", setup.live and "live" or "unit")
...
function get_screenshot_by_domain_and_date_direct_setup(mockres)
