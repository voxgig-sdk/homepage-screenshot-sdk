...
function runner.env_override(m)
  local live = runner.getenv("HOMEPAGE_SCREENSHOT_TEST_LIVE")
  local override = runner.getenv("HOMEPAGE_SCREENSHOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HOMEPAGE_SCREENSHOT_TEST_EXPLAIN")
