...
function runner.env_override(m)
  local live = runner.getenv("HOMEPAGESCREENSHOT_TEST_LIVE")
  local override = runner.getenv("HOMEPAGESCREENSHOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HOMEPAGESCREENSHOT_TEST_EXPLAIN")
