...
local SDK_MODULE = "homepage-screenshot_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["get_screenshot_by_domain"] = { ["test01"] = { id = "test01" } }, ["get_screenshot_by_domain_and_date"] = { ["test01"] = { id = "test01" } } } }'
