...
describe("GetScreenshotByDomainEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOMEPAGESCREENSHOT_TEST_GET_SCREENSHOT_BY_DOMAIN_ENTID JSON to run live")
      return
    end
...
function get_screenshot_by_domain_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOMEPAGESCREENSHOT_TEST_GET_SCREENSHOT_BY_DOMAIN_ENTID")
