...
// HomepageScreenshot SDK streaming feature
...
class HomepageScreenshotStreamingFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _iterate(HomepageScreenshotResult $result): \Generator
    {
    ...
    private function _streamable(HomepageScreenshotContext $ctx): bool
    {
