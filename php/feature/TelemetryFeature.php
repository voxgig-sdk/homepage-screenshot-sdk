...
// HomepageScreenshot SDK telemetry feature
...
class HomepageScreenshotTelemetryFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _close(HomepageScreenshotContext $ctx, bool $ok): void
    {
