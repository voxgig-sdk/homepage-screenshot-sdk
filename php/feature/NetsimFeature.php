...
// HomepageScreenshot SDK netsim feature
...
class HomepageScreenshotNetsimFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _simulate(HomepageScreenshotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HomepageScreenshotContext $ctx, array $applied): void
    {
        $client = $this->client;
