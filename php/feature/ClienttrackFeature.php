...
// HomepageScreenshot SDK clienttrack feature
...
class HomepageScreenshotClienttrackFeature extends HomepageScreenshotBaseFeature
{
    ...
    public function PostConstruct(HomepageScreenshotContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HomepageScreenshot-SDK';
