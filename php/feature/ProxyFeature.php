...
// HomepageScreenshot SDK proxy feature
...
class HomepageScreenshotProxyFeature extends HomepageScreenshotBaseFeature
{
    ...
    public function init(HomepageScreenshotContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HomepageScreenshotContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
