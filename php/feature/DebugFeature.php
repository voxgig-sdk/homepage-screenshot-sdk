...
// HomepageScreenshot SDK debug feature
...
class HomepageScreenshotDebugFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _finish(HomepageScreenshotContext $ctx, bool $ok): void
    {
