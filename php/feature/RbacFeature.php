...
// HomepageScreenshot SDK rbac feature
...
class HomepageScreenshotRbacFeature extends HomepageScreenshotBaseFeature
{
    ...
    private function _required(HomepageScreenshotContext $ctx): ?string
    {
    ...
    private function _reject(HomepageScreenshotContext $ctx, string $required): void
    {
    ...
    private function _track(HomepageScreenshotContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
