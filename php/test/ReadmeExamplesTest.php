...
// HomepageScreenshot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HomepageScreenshotSDK::test)
...
{
    private const SDK_CLASS = 'HomepageScreenshotSDK';
    ...
    private const SDK_BASE = 'homepagescreenshot_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../homepagescreenshot_sdk.php';
