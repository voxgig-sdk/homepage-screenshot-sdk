...
class HomepageScreenshotTestRunner
{
    ...
    {
        $live = self::getenv('HOMEPAGE_SCREENSHOT_TEST_LIVE');
        $override = self::getenv('HOMEPAGE_SCREENSHOT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HOMEPAGE_SCREENSHOT_TEST_EXPLAIN');
...
class_alias('HomepageScreenshotTestRunner', 'Runner');
class_alias('HomepageScreenshotHelpers', 'Helpers');
