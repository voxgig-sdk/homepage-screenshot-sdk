...
// HomepageScreenshot SDK pipeline test
//
...
{
    private static function utility(): HomepageScreenshotUtility
    {
        return new HomepageScreenshotUtility();
    }
    ...
    private static function ctx(array $over = []): HomepageScreenshotContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HomepageScreenshotContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HomepageScreenshotOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HomepageScreenshotError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HomepageScreenshotOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HomepageScreenshotMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HomepageScreenshotOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HomepageScreenshotMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HomepageScreenshotOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HomepageScreenshotMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HomepageScreenshotSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HomepageScreenshotMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HomepageScreenshotResponse([]),
            'result' => new HomepageScreenshotResult([]),
        ]);
        [, $err] = HomepageScreenshotMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec([]),
            'response' => null,
            'result' => new HomepageScreenshotResult([]),
        ]);
        [, $err] = HomepageScreenshotMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec(['step' => 's']),
            'response' => new HomepageScreenshotResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HomepageScreenshotResult([]),
        ]);
        [, $err] = HomepageScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec(['step' => 's']),
            'response' => new HomepageScreenshotResponse(self::resp(200, ['v' => 1])),
            'result' => new HomepageScreenshotResult([]),
        ]);
        [, $err] = HomepageScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec(['step' => 's']),
            'response' => new HomepageScreenshotResponse(self::resp(200, ['v' => 2])),
            'result' => new HomepageScreenshotResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HomepageScreenshotMakeResponse::call($ctx);
    ...
    {
        $preset = new HomepageScreenshotResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec([]),
            'response' => new HomepageScreenshotResponse([]),
            'result' => new HomepageScreenshotResult([]),
        ...
        [$got, $err] = HomepageScreenshotMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HomepageScreenshotResult([])]);
        [, $err] = HomepageScreenshotMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HomepageScreenshotSpec([]), 'result' => null]);
        [, $err] = HomepageScreenshotMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HomepageScreenshotSpec(['step' => 's']),
            'result' => new HomepageScreenshotResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HomepageScreenshotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HomepageScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HomepageScreenshotSpec(['step' => 's']),
            'result' => new HomepageScreenshotResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HomepageScreenshotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HomepageScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HomepageScreenshotResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HomepageScreenshotSpec([]),
            'result' => new HomepageScreenshotResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HomepageScreenshotMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HomepageScreenshotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HomepageScreenshotError('boom', 'boom');
        $utility->fetcher = function (HomepageScreenshotContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HomepageScreenshotSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HomepageScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HomepageScreenshotContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HomepageScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HomepageScreenshotResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HomepageScreenshotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HomepageScreenshotContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HomepageScreenshotSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HomepageScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HomepageScreenshotResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HomepageScreenshotSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HomepageScreenshotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HomepageScreenshotMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HomepageScreenshotMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HomepageScreenshotResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HomepageScreenshotDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HomepageScreenshotResult(['ok' => false])]);
        $this->expectException(HomepageScreenshotError::class);
        HomepageScreenshotDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HomepageScreenshotResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HomepageScreenshotMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HomepageScreenshotMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HomepageScreenshotBaseFeature();
        $b = new HomepageScreenshotBaseFeature();
        HomepageScreenshotFeatureAdd::call($ctx, $a);
        HomepageScreenshotFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HomepageScreenshotBaseFeature
    {
        $f = new HomepageScreenshotBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HomepageScreenshotFeatureAdd::call($ctx, self::named_feature('a'));
        HomepageScreenshotFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HomepageScreenshotFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HomepageScreenshotFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HomepageScreenshotFeatureAdd::call($ctx, $replace);
        ...
        HomepageScreenshotFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HomepageScreenshotContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HomepageScreenshotSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HomepageScreenshotPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HomepageScreenshotPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HomepageScreenshotResponse(['headers' => null]),
            'result' => new HomepageScreenshotResult([]),
        ]);
        HomepageScreenshotResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HomepageScreenshotResultBody::call($ctx);
