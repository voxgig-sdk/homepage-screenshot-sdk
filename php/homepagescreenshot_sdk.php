...
class HomepageScreenshotSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HomepageScreenshotHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HomepageScreenshotHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HomepageScreenshotFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HomepageScreenshotFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HomepageScreenshotUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HomepageScreenshotHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HomepageScreenshotHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HomepageScreenshotHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HomepageScreenshotError($op . "_allow",
                "HomepageScreenshotSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HomepageScreenshotHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HomepageScreenshotError("graphql_error",
                "HomepageScreenshotSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetScreenshotByDomain($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_screenshot_by_domain === null) {
                $this->_get_screenshot_by_domain = new GetScreenshotByDomainEntity($this, null);
            }
            return $this->_get_screenshot_by_domain;
        }
        return new GetScreenshotByDomainEntity($this, $data);
    }
    ...
    public function GetScreenshotByDomainAndDate($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_screenshot_by_domain_and_date === null) {
                $this->_get_screenshot_by_domain_and_date = new GetScreenshotByDomainAndDateEntity($this, null);
            }
            return $this->_get_screenshot_by_domain_and_date;
        }
        return new GetScreenshotByDomainAndDateEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HomepageScreenshotSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
