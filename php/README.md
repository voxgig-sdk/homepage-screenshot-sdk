# HomepageScreenshot PHP SDK



The PHP SDK for the HomepageScreenshot API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($getscreenshotbydomain->data_get());
} catch (\Throwable $err) {
...
```
php/
├── homepagescreenshot_sdk.php          -- Main SDK class
...
The main class (`homepagescreenshot_sdk.php`) exports the SDK class
