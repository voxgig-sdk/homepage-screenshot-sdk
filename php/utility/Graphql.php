...
// HomepageScreenshot SDK utility: graphql
//
...
class HomepageScreenshotGraphql
{
    ...
    // equivalent.
    public static function body(HomepageScreenshotContext $ctx): mixed
    {
    ...
    public static function errors(HomepageScreenshotContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
